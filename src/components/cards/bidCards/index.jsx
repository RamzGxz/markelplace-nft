...
const BidsCard = ({ image, title, desc, price, bidPrice, likes }) => {
  return (
    <div className='w-full p-5 rounded-md bg-primary/5 flex flex-col gap-5'>
      <div className='w-full h-44 bg-gradient-to-r from-secondary to-accent rounded-md'></div>
      ...
      <div className='flex justify-between items-center'>
        <button className='px-2 p-1 text-xs border border-accent text-accent rounded-md font-semibold hover:bg-accent hover:text-text transition-all duration-150'>Place Bids</button>
