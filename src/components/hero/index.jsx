  ...
  return (
    <div className='w-full justify-between flex items-center lg:pt-28 pt-16' id='home'>
      <div className='flex lg:w-1/2 w-full flex-col gap-5 items-start justify-start'>
        <h1 className='lg:text-7xl text-5xl font-black lg:leading-normal leading-snug'>Buy, Sell and collect <span className='bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent'>NFTs.</span></h1>
        ...
        <div className='flex items-center gap-5'>
          <button className='lg:px-10 px-8 lg:py-3 py-2 rounded-md bg-accent font-semibold hover:bg-accent/80'>Upload</button>
          <button className='lg:px-10 px-8 lg:py-3 py-2 rounded-md bg-secondary font-semibold hover:bg-secondary/80'>Explore</button>
        </div>
      </div>
